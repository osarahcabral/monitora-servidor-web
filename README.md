...
<p align="center">
	<img alt="Status Em Desenvolvimento" src="https://img.shields.io/badge/STATUS-CONCLUÍDO%20-green">
    <img alt="GitHub last commit" src="https://img.shields.io/github/last-commit/osarahcabral/monitora-servidor-web">
    <img alt="Tamanho do Repositório" src="https://img.shields.io/github/repo-size/osarahcabral/monitora-servidor-web">
</p>
...
O projeto foi desenvolvido durante a 1º Sprint do Programa Compass.Uol Scholarship em 2025, que tinha por desafio construir uma instância Amazon EC2 com um servidor Nginx no Ubuntu 24.04 e um script de monitoramento e notificação através do Webhook Discord.
...
[![Tenologias](https://skillicons.dev/icons?i=linux,bash,ubuntu,discord,nginx,aws,git,github)](https://skillicons.dev)
